...
def load_recent_reviews():
    """Загрузка последних проверенных MR"""
    try:
        ...
        # Backend not available, return empty
        pass
...
if page == "📊 Аналитика":
    ...
    if recent_reviews:
        ...
        st.info("Нет данных. Создайте MR в GitLab чтобы увидеть активность.")
